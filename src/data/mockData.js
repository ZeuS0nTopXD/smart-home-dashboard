export const initialDashboardData = {
  ...
  modules: {
    ...
    entrance: {
      ...
      statusLabel: 'Armed',
      armed: true,
      door: 'Front door locked',
      lastEvent: 'No activity for 2h 18m'
    },
    solar: {
      id: 'solar',
    ...
    earthquake: {
      id: 'earthquake',
      label: 'Earthquake detection',
      shortLabel: 'Seismic',
      status: 'safe',
      statusLabel: 'Stable',
      reading: '0.02 g',
      lastEvent: 'No movement detected'
    },
    rain: {
      id: 'rain',
      label: 'Smart rain storage',
      shortLabel: 'Rain',
      status: 'warning',
      statusLabel: 'Reserve',
      level: 78,
    ...
    climate: {
      id: 'climate',
      label: 'Light + fan automation',
      shortLabel: 'Climate',
      status: 'safe',
      statusLabel: 'Auto mode',
      lightOn: true,
      fanOn: false,
      scene: 'Evening comfort'
    }
  }
};
